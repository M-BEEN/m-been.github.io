...
계좌를 열면 두 종목이 있다. 하나는 +8%, 하나는 -22%다. 오늘 현금이 필요해서 하나를 팔아야 한다면, 대부분 +8%짜리를 판다. 이유도 비슷하다. "저건 이미 벌었으니 챙기고, 이건 아직 안 팔았으니 손해가 확정된 게 아니다." 이 글이 답하려는 질문은 하나다. 이 흔한 선택이 왜 계좌 성적을 깎는가.
